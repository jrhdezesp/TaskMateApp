...
public class TareasUrgentes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregarTask.setOnClickListener(view ->
                startActivity(new Intent(TareasUrgentes.this, Tareas.class))
        );
