...
public class TareasModeradas extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregarTask.setOnClickListener(view ->
                startActivity(new Intent(TareasModeradas.this, Tareas.class))
        );
